...
class AF {
  ...
  static Color get textDim   => Colors.white.withValues(alpha: 0.70);
  static Color get textMuted => Colors.white.withValues(alpha: 0.54);
  static Color get textFaint => Colors.white.withValues(alpha: 0.38);
...
List<BoxShadow> afGlow(Color c, {double blur = 16, double opacity = 0.55, Offset offset = Offset.zero}) =>
    [BoxShadow(color: c.withValues(alpha: opacity), blurRadius: blur, offset: offset)];
